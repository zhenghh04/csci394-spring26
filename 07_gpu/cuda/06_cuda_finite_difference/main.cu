...
int main(int argc, char **argv) {
    ...
    cudaMalloc((void **)&device_f, bytes);
    cudaMalloc((void **)&device_df, bytes);
    cudaMemcpy(device_f, host_f, bytes, cudaMemcpyHostToDevice);
    ...
    cudaMemcpy(host_df, device_df, bytes, cudaMemcpyDeviceToHost);
